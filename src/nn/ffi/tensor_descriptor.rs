...
#[inline]
pub fn cudnn_set_tensor_4d_descriptor(tensor_desc: *mut _TensorDescriptorStruct, format: CudnnTensorFormat, data_type: CudnnDataType, n: i32, c: i32, h: i32, w: i32) {
    #[cfg(not(feature = "disable_checks"))] {
